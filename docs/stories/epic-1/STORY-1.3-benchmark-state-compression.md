...
## Descrição
Medir o custo de comprimir dados via Merkle tree (state compression) e o custo por leaf/asset em função do tamanho da árvore.
...
- [ ] Tabela de custo por leaf × depth/canopy (referência Metaplex).

## Notas Técnicas
- Custos de referência (Metaplex): 1M cNFTs ≈ 5.3 SOL (~0.000005 SOL/asset).
